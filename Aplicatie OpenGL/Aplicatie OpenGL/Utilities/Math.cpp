...
Vector3 & Vector3::operator=(Vector4 const & vector)
{
	x = vector.x;
	y = vector.y;
	z = vector.z;
...
Matrix & Matrix::SetOrtho(GLfloat left, GLfloat right, GLfloat top, GLfloat bottom, GLfloat nearPlane, GLfloat farPlane)
{
	m[0][0] = 2/(right-left);
	m[1][0] = 0;
	m[2][0] = 0;

...
void Shader::Load()
{
	...
	char uniformName[100] = "lightMatrix[0]";
	for (int i = 0; i < 6; i++)
	{
		uniformName[12] = i + '0';
		lightMatrixUniform[i] = glGetUniformLocation(programId, uniformName);
	}
	...
	strcpy(uniformName, "lightDepth1[0]");
	for (int i = 0; i < 6; i++)
	{
		uniformName[12] = i + '0';
		lightDepth1Uniform[i] = glGetUniformLocation(programId, uniformName);
	}
	strcpy(uniformName, "lightDepth2[0]");
	for (int i = 0; i < 6; i++)
	{
		uniformName[12] = i + '0';
		lightDepth2Uniform[i] = glGetUniformLocation(programId, uniformName);
	}
	strcpy(uniformName, "lightDepth3[0]");
	for (int i = 0; i < 6; i++)
	{
		uniformName[12] = i + '0';
		lightDepth3Uniform[i] = glGetUniformLocation(programId, uniformName);
	}
	strcpy(uniformName, "lightDepth4[0]");
	for (int i = 0; i < 6; i++)
	{
		uniformName[12] = i + '0';
		lightDepth4Uniform[i] = glGetUniformLocation(programId, uniformName);
	}
	...
	int k;
	for (k = 0; k < 6; k++)
		if (lightDepth1Uniform[k] != -1)glUniform1i(lightDepth1Uniform[k], i++);
	for (k = 0; k < 6; k++)
		if (lightDepth2Uniform[k] != -1)glUniform1i(lightDepth2Uniform[k], i++);
	for (k = 0; k < 6; k++)
		if (lightDepth3Uniform[k] != -1)glUniform1i(lightDepth3Uniform[k], i++);
	for (k = 0; k < 6; k++)
		if (lightDepth4Uniform[k] != -1)glUniform1i(lightDepth4Uniform[k], i++);
	glUseProgram(0);
}

...
Shader * ResourceManager::reqGrayScaleShader()
{
...
Shader * ResourceManager::reqDepthShader()
{
	const int id_filterShader = -325;
	auto &shaders_iterator = shaders.find(id_filterShader);
	if (shaders_iterator != shaders.end())
		return &shaders_iterator->second;
	auto filterShader = &shaders.try_emplace(id_filterShader, &shaderResources[id_filterShader]
...
Shader * ResourceManager::reqSimpleTextureShader()
{
	const int id_filterShader = -326;
	auto &shaders_iterator = shaders.find(id_filterShader);
	if (shaders_iterator != shaders.end())
		return &shaders_iterator->second;
	auto filterShader = &shaders.try_emplace(id_filterShader, &shaderResources[id_filterShader]
...
Shader * ResourceManager::reqLightDepthShader()
{
	const int id_filterShader = -327;
	auto &shaders_iterator = shaders.find(id_filterShader);
	if (shaders_iterator != shaders.end())
		return &shaders_iterator->second;
	auto filterShader = &shaders.try_emplace(id_filterShader, &shaderResources[id_filterShader]

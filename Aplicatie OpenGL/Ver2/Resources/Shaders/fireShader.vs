...
position.y += textureColorBlend.r * 3.0 + textureColorBlend.g * 2.0 + textureColorBlend.b * (-1.0);

gl_Position = transfMatrix * position;
fragPos = vec3(modelMatrix * position);
//gl_Position.y += textureColorBlend.r * heightMap.r + textureColorBlend.g * heightMap.g + textureColorBlend.b * heightMap.b; 
}

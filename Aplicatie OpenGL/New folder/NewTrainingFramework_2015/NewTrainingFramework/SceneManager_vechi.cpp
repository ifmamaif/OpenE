...
void SceneManager::Draw()
{
	...
	glBindTexture(GL_TEXTURE_2D, texture1);
	ResourceManager::getInstance()->reqGrayScaleShader()->Use();
	...
	glBindTexture(GL_TEXTURE_2D, texture3);
	//ResourceManager::getInstance()->reqDepthShader()->Use();
	//ResourceManager::getInstance()->reqDepthShader()->Send_r(active_cameraPtr->cam_near);
	//ResourceManager::getInstance()->reqDepthShader()->Send_R(active_cameraPtr->cam_far);

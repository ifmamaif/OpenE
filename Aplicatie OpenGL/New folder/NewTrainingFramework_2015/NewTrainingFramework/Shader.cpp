...
void Shader::Load()
{
	...
	char uniformName[] = "lightMatrix[0]";
	for (int i = 0; i < 4; i++)
	{
		uniformName[12] = i + '0';
	...
	lightDepth1Uniform = glGetUniformLocation(programId, "lightDepth1");
	lightDepth2Uniform = glGetUniformLocation(programId, "lightDepth2");
	lightDepth3Uniform = glGetUniformLocation(programId, "lightDepth3");
	lightDepth4Uniform = glGetUniformLocation(programId, "lightDepth4");
	...
	if (lightDepth1Uniform != -1)glUniform1i(lightDepth1Uniform, i++);
	if (lightDepth2Uniform != -1)glUniform1i(lightDepth2Uniform, i++);
	if (lightDepth3Uniform != -1)glUniform1i(lightDepth3Uniform, i++);
	if (lightDepth4Uniform != -1)glUniform1i(lightDepth4Uniform, i++);
	glUseProgram(0);
}
